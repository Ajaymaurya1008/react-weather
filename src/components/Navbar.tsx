...
const Navbar = () => {
  ...
  return (
    <header className="relative bg-gradient-to-l from-slate-800 to-violet-900 flex w-screen dark:from-gray-800 dark:to-gray-900 dark:text-gray-200 flex-col overflow-hidden px-20 py-4 text-white  md:flex-row md:items-center">
      <a
        href="#"
